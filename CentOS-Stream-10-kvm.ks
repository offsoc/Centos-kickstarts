# Kickstart file to build CentOS-Stream-10 Guest image.
...
reqpart
part / --fstype="ext4" --mkfsoptions "-m bigtime=0,inobtcount=0" --ondisk=vda --size=8000
reboot
...
# rhevm guest-agent (Not available in CentOS-Stream-10 yet)
